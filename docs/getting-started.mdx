...
For a more advanced example, check the [`RegisterForm`](./example/lib/main.dart#L10) widget that is used in the [demo](https://youssefraafatnasry.github.io/lo_form/).
